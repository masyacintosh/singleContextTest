...
@interface singleContextTestObject : KrollCoverageObject {
#else
@interface singleContextTestObject : KrollObject {
#endif
@private
...
extern NSString * singleContextTest$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	singleContextTestObject *_singlecontexttest;
	BOOL shutdown;
