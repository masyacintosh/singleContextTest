...
// in simulator we redefine to format for singleContextTest Developer console
...
{\
	NSString * exceptionName = [@"org.singlecontexttest." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.singlecontexttest";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIsingleContextTestNativeItemNone = -1, 
	UIsingleContextTestNativeItemSpinner = -2,
	UIsingleContextTestNativeItemProgressBar = -3,
	
	UIsingleContextTestNativeItemSlider = -4,
	UIsingleContextTestNativeItemSwitch = -5,
	UIsingleContextTestNativeItemMultiButton = -6,
	UIsingleContextTestNativeItemSegmented = -7,
	
	UIsingleContextTestNativeItemTextView = -8,
	UIsingleContextTestNativeItemTextField = -9,
	UIsingleContextTestNativeItemSearchBar = -10,
	
	UIsingleContextTestNativeItemPicker = -11,
	UIsingleContextTestNativeItemDatePicker = -12,
	
	UIsingleContextTestNativeItemInfoLight = -13,
	UIsingleContextTestNativeItemInfoDark = -14,
	
	UIsingleContextTestNativeItemDisclosure = -15,
	
	UIsingleContextTestNativeItemContactAdd = -16
};
