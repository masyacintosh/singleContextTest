 ...
 * Copyright (c) 2009-2011 by singleContextTest, Inc. All Rights Reserved.
...
//@interface singleContextTestObject : NSObject
//@end

@interface singleContextTestObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[singleContextTestObject class]])
		{
			for (NSString *key in [[(singleContextTestObject*)o modules] allKeys])
			{
